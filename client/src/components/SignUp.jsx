    ...
    <>
      <div className="fixed inset-0 bg-paynes_gray backdrop-blur-sm flex items-center justify-center gap-3 z-20">
        <Transition appear show={open || false}>
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 30 }} className={`${isRegister ? "flex-col items-start justify-start w-[30rem] h-[35rem] border-white border-2 bg-slate-200 rounded-xl gap-2 mt-20" : "flex-col items-start justify-start w-[25rem] h-[25rem] border-white border-2 bg-slate-200 rounded-xl gap-2 mt-20"}`}>
